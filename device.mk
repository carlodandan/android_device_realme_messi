...
# A/B
AB_OTA_PARTITIONS += system system_ext vendor product odm boot dtbo vbmeta vbmeta_system
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/media/odm/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_ODM)/etc/media_profiles_V1_0.xml
